...
While we only need the quarter-by-quarter scores of each game, only the player stats dataset has the requred quarter scores on it for some reason. Thus, we will create a version of this 
